...
We will use graphical barcharts, numerical tables and chisq test to find the p-value. To find out if there is a correlation between the use of the drug and the subjects susceptibility to contracting aids.
...
The p-value for the chisq test is 0 < 0.05 suggests there is a connection between the drug and the LGBTQ popualation on the experimental drug becoming more susceptible to aids.

# Discussion and Conclusion

We reject the null hypothesis and conclude that we have evidence to support that there is a connection in the LGBTQ population who are on the drug and their susceptibility to contracting aids.
