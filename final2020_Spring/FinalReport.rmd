...
We will use graphical barcharts, numerical tables and infrarential methods to find the p-value. To find out if there is a correlation between the use of the drug and the subjects susceptibility to contracting aids.
...
We fail to reject the null hypothesis and conclude that we have evidence to support that this drug does reduce the likelyhood in contracting aids.
...
We fail to reject the null hypothesis and conclude that we have evidence to support that this drug does reduce the likelyhood in the women who are on the drug from contracting aids.
...
Since the p-value is 1e-04 < 0.05 we fail to reject to null hypothesis and conclude we have evidence to support that the drug does have an effect on men who use the drug versus those who didn't use the drug.
...
This barchart shows that the drug has no effect on the LGBTQ population and they are more likely to contract aids than if they got the placebo.
...
The p-value for the chisq test is 0 < 0.05 suggests there is a connection between the drug and the LGBTQ popualation on the experimental drug becoming less susceptible to aids.

# Discussion and Conclusion

We fail to reject the null hypothesis and conclude that we have evidence to support that this drug does reduce the likelyhood in the LGBTQ population who are on the drug from contracting aids.
...
We fail to reject the null hypothesis and conclude that we have evidence to support that this drug does reduce the likelyhood in drugusers who are on the drug from contracting aids.
